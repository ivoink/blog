...
![image-20260318174814358](/posts/specks/hugo-blog-setup/assets/image-20260318174814358.png)

打开命令行窗口

![image-20260318174925151](/posts/specks/hugo-blog-setup/assets/image-20260318174925151.png)
...
![image-20260318175107061](/posts/specks/hugo-blog-setup/assets/image-20260318175107061.png)

![image-20260318175133830](/posts/specks/hugo-blog-setup/assets/image-20260318175133830.png)
...
![image-20260318175915991](/posts/specks/hugo-blog-setup/assets/image-20260318175915991.png)

下载后解压，重命名为`blowfish`并放置在博客的`themes`目录下

![image-20260318180052330](/posts/specks/hugo-blog-setup/assets/image-20260318180052330.png)

进入`blowfish`目录将`exampleSite`目录拷贝至博客根目录即可

![image-20260318180219708](/posts/specks/hugo-blog-setup/assets/image-20260318180219708.png)

![image-20260318180231588](/posts/specks/hugo-blog-setup/assets/image-20260318180231588.png)

#### 预览

将`hugo.exe`二进制文件拷贝至博客根目录，打开`cmd`窗口

![image-20260318180418109](/posts/specks/hugo-blog-setup/assets/image-20260318180418109.png)
...
![image-20260318183515431](/posts/specks/hugo-blog-setup/assets/image-20260318183515431.png)

这个是`GitHub`上面我的零碎随笔目录

**本地**

![image-20260318183559770](/posts/specks/hugo-blog-setup/assets/image-20260318183559770.png)

这个则是我本地的。

**也就是说，上传GitHub之后所有的大写字母全部是小写，所以文章引用图片路径全部要是小写**

![image-20260318183707130](/posts/specks/hugo-blog-setup/assets/image-20260318183707130.png)
