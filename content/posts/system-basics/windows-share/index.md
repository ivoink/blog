...
![image-20260409111015349](/posts/system-basics/windows_share/assets/image-20260409111015349.png)

### 配置

在上面的分享板块，也就是截图的`Network File and Folder Sharing`里面，可以添加可访问的人员：

![image-20260409111230588](/posts/system-basics/windows_share/assets/image-20260409111230588.png)

在高级权限中，也就是截图中的`Advanced Sharing`里面，即可设置共享路径

![image-20260409113028135](/posts/system-basics/windows_share/assets/image-20260409113028135.png)

在密码保护，也就是截图中`Password Protection`里面

![{F9A1B348-8EA2-4192-A161-5AB1E04C31E4}](/posts/system-basics/windows_share/assets/{F9A1B348-8EA2-4192-A161-5AB1E04C31E4}.png)
