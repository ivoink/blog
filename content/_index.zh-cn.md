...
document.addEventListener('DOMContentLoaded', function () {
  const links = [
    { name: "Ink-Explorer-Well", desc: "我的知识库，暂时还没有完成，完成后所有笔记以及详细完整的教程都会收录在此处", url: "https://docs.ivoink.qzz.io", logo: "https://docs.ivoink.qzz.io/apple-touch-icon-167x167.png" },
